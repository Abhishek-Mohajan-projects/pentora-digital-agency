...
(function () {
  ...
  document.addEventListener('DOMContentLoaded', function () {
    ...
    function recalcBannerOffset() {
      ...
      if (annBar && annBar.offsetHeight > 0) aboveTotal += annBar.offsetHeight;

      var holiday = document.querySelector('.holiday-notice');
      if (holiday && holiday.classList.contains('show') && holiday.offsetHeight > 0) aboveTotal += holiday.offsetHeight;

      var offer = document.getElementById('offer-banner');
      if (offer && offer.classList.contains('show') && offer.offsetHeight > 0) belowTotal += offer.offsetHeight;
